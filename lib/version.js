...
module.exports = function(api, parent, verOpts) {
    ...
    var addEndpoint = function(method, opts) {
        ...
        var docRoute = verOpts.docsPath + "/" + opts.route;
        var docsObj = {
            method: method,
            desc: opts.desc,
            depecated: opts.depecated,
            discontinued: opts.discontinued,
            parent: ver.parent == null ? null : ver.parent.docRoutes[docRoute]
        };
        ...
        ver.docRoutes[docRoute] = ver.docRoutes[docRoute] ? ver.docRoutes[docRoute].add(docsObj) : doctor(docsObj);
    }
