...
module.exports = function(api, parent, verOpts) {
    ...
    ver.router = function(routeName, type, req, res, next) {
        ...
        if (req.type) {
            routeName = routeName.replace("." + req.type, "");
        }
        ...
        if (opts.discontinued) { //if this endpoint is discontinued, provide the discontinued controller
            ...
            if (opts.controller == undefined || opts.validate.request == undefined || opts.validate.response == undefined) {
                ...
                if (oldEndpoint == undefined) {
                    error("Controller, opts.validate.request and opts.validate.response are required when defineing a new endpoint", 4);
                } else {
                    opts.validate.request = opts.validate.request || oldEndpoint.opts.validate.request;
                    ops.validate.response = ops.validate.response || oldEndpoint.opts.validate.response;
